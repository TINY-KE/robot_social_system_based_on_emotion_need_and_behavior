...
void LoclistInit(LocalList &list){
    ...
    list.bhv[3].speech.weight = 0;
    list.bhv[3].speech.call = 0;
    list.bhv[3].speech.content = "0";
    list.bhv[3].speech.tone = 0;
    list.bhv[3].speech.rate = 0;
    list.bhv[3].speech.startTime = 0;
    list.bhv[3].speech.endTime = 0;
    ...
    list.bhv[5].gaze.weight = 1;
    list.bhv[5].gaze.call = 1;
    ...
    list.bhv[5].legs.weight = 1;
    list.bhv[5].legs.call = 1;
    ...
    list.bhv[6].legs.weight = 0;
    list.bhv[6].legs.call = 0;
...
void TaskInsert(Queue_para* ptr, social_msg::bhvPara item)
{
    ...
    if(CanInterrupt(ptr,tasks.states))
    {
        ...
        InsertTask = item;
        InsertTask.num = 100;
        InsertTask.Needs = TransTask.Needs;
...
void ParaInsert(Queue_para* ptr, social_msg::bhvPara item)
{
    ...
    if(n == 0) 
        Append(ptr, item);
            ...
            //并发判断
            if(CanConcurrence(ptr, item, tasks.states))
