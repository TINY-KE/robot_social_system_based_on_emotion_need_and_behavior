...
#include "visualize/robot_emotion.h"
#include "visualize/robot_status.h"
#include "visualize/perception_msg.h"
#include "common.h"
/*****************************************************************************
** Namespaces
*****************************************************************************/
...
//  void log_sub( const LogLevel &level, const std::string &msg); //add
  void Callback_emotion(const visualize::robot_emotion &msg);
  void Callback_body(const visualize::robot_status &msg);
  void Callback_percetion(const visualize::perception_msg &msg);
  void Callback_need(const visualize::need_msg &msg);
