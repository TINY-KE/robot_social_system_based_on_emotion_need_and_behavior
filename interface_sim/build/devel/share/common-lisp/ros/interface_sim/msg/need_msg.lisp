...
(cl:defclass <need_msg> (roslisp-msg-protocol:ros-message)
  ((need_name
    :reader need_name
    :initarg :need_name
    :type cl:string
...
(cl:defclass need_msg (<need_msg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <need_msg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'need_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interface_sim-msg:<need_msg> is deprecated: use interface_sim-msg:need_msg instead.")))

(cl:ensure-generic-function 'need_name-val :lambda-list '(m))
(cl:defmethod need_name-val ((m <need_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interface_sim-msg:need_name-val is deprecated.  Use interface_sim-msg:need_name instead.")
  (need_name m))

(cl:ensure-generic-function 'person_name-val :lambda-list '(m))
(cl:defmethod person_name-val ((m <need_msg>))
...
(cl:defmethod IDtype-val ((m <need_msg>))
...
(cl:defmethod rob_emotion-val ((m <need_msg>))
...
(cl:defmethod person_emotion-val ((m <need_msg>))
...
(cl:defmethod weight-val ((m <need_msg>))
...
(cl:defmethod speech-val ((m <need_msg>))
  ...
  (speech m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <need_msg>) ostream)
  "Serializes a message object of type '<need_msg>"
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'need_name))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'need_name))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <need_msg>) istream)
  "Deserializes a message object of type '<need_msg>"
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'need_name) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'need_name) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<need_msg>)))
  "Returns string type for a message object of type '<need_msg>"
  "interface_sim/need_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'need_msg)))
  "Returns string type for a message object of type 'need_msg"
  "interface_sim/need_msg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<need_msg>)))
  "Returns md5sum for a message object of type '<need_msg>"
  "89d9fdc137ce49edd6361ad65d7aec1f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'need_msg)))
  "Returns md5sum for a message object of type 'need_msg"
  "89d9fdc137ce49edd6361ad65d7aec1f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<need_msg>)))
  "Returns full string definition for message of type '<need_msg>"
  (cl:format cl:nil "string need_name~%string person_name~%string IDtype~%string rob_emotion~%string person_emotion~%float64 weight~%string speech~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'need_msg)))
  "Returns full string definition for message of type 'need_msg"
  (cl:format cl:nil "string need_name~%string person_name~%string IDtype~%string rob_emotion~%string person_emotion~%float64 weight~%string speech~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <need_msg>))
  (cl:+ 0
     4 (cl:length (cl:slot-value msg 'need_name))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <need_msg>))
  "Converts a ROS message object to a list"
  (cl:list 'need_msg
    (cl:cons ':need_name (need_name msg))
